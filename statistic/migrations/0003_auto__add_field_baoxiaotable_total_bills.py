...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaoXiaoTable.total_bills'
        db.add_column('statistic_baoxiaotable', 'total_bills',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaoXiaoTable.total_bills'
        db.delete_column('statistic_baoxiaotable', 'total_bills')
    ...
    models = {
        ...
        'statistic.baoxiaotable': {
            ...
            'total_bills': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
