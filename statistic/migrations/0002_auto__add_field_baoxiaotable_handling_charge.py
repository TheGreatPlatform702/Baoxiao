...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaoXiaoTable.handling_charge'
        db.add_column('statistic_baoxiaotable', 'handling_charge',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='handling_set', to=orm['statistic.DetailMoney']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaoXiaoTable.handling_charge'
        db.delete_column('statistic_baoxiaotable', 'handling_charge_id')
