...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaoXiaoTable.total_money'
        db.add_column('statistic_baoxiaotable', 'total_money',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


        # Changing field 'BaoXiaoTable.total_bills'
        db.alter_column('statistic_baoxiaotable', 'total_bills', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting field 'BaoXiaoTable.total_money'
        db.delete_column('statistic_baoxiaotable', 'total_money')


        # Changing field 'BaoXiaoTable.total_bills'
        db.alter_column('statistic_baoxiaotable', 'total_bills', self.gf('django.db.models.fields.FloatField')())
